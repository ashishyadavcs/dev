...
const Editor = ({ styles, addPost, updatePost, edit, data }) => {
    ...
    return (
        <div className={`${styles.addpost}`}>
            <form
                className="my-3"
                onSubmit={e => (edit ? updatePost(e, edit._id, faq) : addPost(e, faq, categories))}
            ...
            >
                ...
                <div className="row">
                    ...
                    <div className="col-md-4">
                        ...
                        <label>
                            Keyword
                            <input defaultValue={edit?.keywords} type="text" name="keywords" />
                        </label>
                        <label>
                            thumbnail
                            <input
                        ...
                        {thumbnail && (
                            <img height={"auto"} width="100%" lo src={thumbnail} alt="" />
                        )}
                        {faq.map((item, i) => (
