    ...
    <>
      <div className='flex container py-4'>
        ...
        <div>
          ...
          <input type="text" onChange={e => dispatch(changeName(e.target.value))}></input>
        </div>
      </div>
      <div className='container'>
        ...
        <div>
          ...
          <input type="text" onChange={e => dispatch(changeServiceName(e.target.value))}></input>
        </div>
        <div>
          <h2>{service?.price}</h2>
          <label>chnage service price</label>
          <input type="text" onChange={e => dispatch(changePrice(e.target.value))}></input>
        </div>
      </div>
    </>
  )
