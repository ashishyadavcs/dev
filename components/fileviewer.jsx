...
import { MdKeyboardArrowLeft, MdOutlineClose, MdKeyboardArrowRight } from "react-icons/md";
            ...
            {apiHit ? (
                ...
                <div className={`${styles.body} z-50`}>
                    ...
                    <MdKeyboardArrowRight
                        onClick={e => setData({ ...data, index: data.index + 1 })}
                        className={`${styles.navigation} ${
                            data.index == data.files.length ? "disabled" : ""
                        } ${styles.right}`}
                        size={20}
                        color="#fff"
                    />
                    <div className={`${styles.tool} flex items-center`}>
                        ...
                        {data?.files[index]?.type.includes("pdf") ? (
                            <RiFileEditFill onClick={e => setEditor(true)} title="Edit" size={18} />
                        ) : data.files[index]?.type.includes("image") ? (
                            <RiImageEditFill
                        ...
                        <MdOutlineClose title="close" onClick={e => handler(false)} size={20} />
                    </div>
