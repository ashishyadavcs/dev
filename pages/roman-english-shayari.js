...
const Page = ({ data }) => {
    ...
    const copy = text => {
        ...
        input.remove();
        document.querySelector(`.${styles.copied}`).classList.add(`${styles.active}`);
        setTimeout(() => {
    ...
    return (
        <>
            <Banner
                ...
                height="40vh"
                title="Shayari in roman english"
            />
            ...
            <div className={`container article my-2 ${styles.shayaries}`}>
                ...
                <article className="col">
                    <p className="text-center sub">
                        Top roman english shayari with english meaning , heart touching shayari in
                        roman english & roman meaning, read collection of roman english shayari copy
                        & download
                    </p>
                ...
                <Toc />
                {download && (
                    <DownloadPopup handler={setdownload} src={download.url} styles={styles} />
                )}
            </div>
        </>
    );
