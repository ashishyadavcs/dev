      ...
      >
        <div className="form-field">
          ...
          <input
            value={calculator.st}
            onChange={(e) =>
              setcalculator((prev) => ({ ...prev, st: e.target.value }))
            }
            id="st"
            type="datetime-local"
          />
        ...
        <div className="form-field">
          ...
          <input
            value={calculator.et}
            onChange={(e) =>
              setcalculator((prev) => ({ ...prev, et: e.target.value }))
            }
            id="et"
            type="datetime-local"
          />
        ...
        <div className="solve">
          {calculator.result && <button className="btn btn-default">{calculator.result} Horas</button>}
