...
const Page = () => {
    ...
    return (
        ...
        }} title={'Esercizi di html'} height="20vw"></Banner>
        <Pagestyle className="container py-4">
            ...
            <ul>
                ...
                <li>
                    Crea un nuovo file e salvalo con un'estensione .html (ad esempio, index.html).
                </li>
            </ul>
            <h3>Struttura HTML:</h3>
            <ul>
                <li>
                    All'interno del tuo file HTML, crea la struttura di base di un documento HTML
...
`}
            ...
            <ul>
                <li>
                    Trova un'immagine online (assicurati di avere il diritto di usarla) e salvala
                    nella stessa directory del tuo file HTML.
                </li>
...
`}
            ...
            <p>
                Aggiungi un collegamento {`<a>`} a un sito web esterno (ad esempio, il tuo sito web
                preferito).
            </p>
            <Codeblock
                mode="html"
...
`}
            ...
            <p>Questo esercizio è progettato per aiutarti a esercitarti nella struttura di base di un documento HTML, aggiungendo contenuto testuale, comprese immagini, e creando collegamenti. Sentiti libero di personalizzare il contenuto e sperimentare elementi HTML aggiuntivi!</p>
        <p>esercita più argomenti HTML da <a style={{textDecoration:'underline'}} href="https://www.w3schools.com/html/default.asp">w3schools</a></p>
        </Pagestyle>
        </>
    );
};
