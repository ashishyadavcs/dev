...
box-shadow: ${data.boxShadow.x}px ${data.boxShadow.y}px ${
    data.boxShadow.blur
  }px ${data.boxShadow.spread}px ${data.boxShadow.color};
text-shadow: ${data.textShadow.x}px ${data.textShadow.y}px ${
    data.textShadow.blur
  }px;
transition:all 0.3s;
}`;
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setdata((prev) => ({
                        ...
                        font: {
                          ...prev.font,
                          [f]: f == "bold" ? e.target.checked : e.target.value,
                        },
                      }))
                    }
                  />
                ...
                <label key={i}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setdata((prev) => ({
                        ...prev,
                        boxShadow: { ...prev.boxShadow, [el]: e.target.value },
                      }))
                    }
                  />
                </label>
...
.btn{${buttonstyle.trim()}
      ...
      <section className={styles.content}>
        <div className="container">
          <h1 className="text-center my-4">HTML CSS Button Generator</h1>
          <p>
            CSS (Cascading Style Sheets) is a styling language that can be used
            to enhance the look and feel of HTML elements, including buttons.
            While creating buttons from scratch using CSS can be time-consuming
            and require a good understanding of CSS, a CSS button generator can
            make the process much simpler.
          </p>
          <h2>What is a CSS Button Generator?</h2>

          <p>
            A CSS button generator is an online tool that allows you to create
            custom buttons using CSS without writing any code. It provides a
            user-friendly interface where you can choose the size, shape, color,
            and other properties of the button. The CSS button generator then
            generates the CSS code that you can use to style your buttons.
          </p>
          <Image
            className="my-4"
            height={600}
          ...
          <p>
            There are several reasons why you might want to use a CSS button
            generator:
          </p>
          <ol style={{ listStylePosition: "inside" }}>
            <li>
              Time-saving: Creating buttons from scratch using CSS can take a
              lot of time, especially if you&apos;re not familiar with the
              language. A CSS button generator can save you time by generating
              the code for you.
            </li>
            <li>
            ...
            <li>
              Customizable: With a CSS button generator, you can choose from a
              variety of sizes, shapes, colors, and other properties to create
              buttons that match the look and feel of your website.
            </li>
            <li>
              No coding required: If you&apos;re not familiar with CSS, a CSS
              button generator is a great way to create buttons without writing
              any code.
            </li>
          </ol>
          <h2>conclusion</h2>
          <p>
            In conclusion, a CSS button generator is a useful tool for creating
            custom buttons for your website or application. It saves time, is
            easy to use, customizable, and doesn&apos;t require any coding
            knowledge. So if you&apos;re looking to create buttons for your
            website, consider using a CSS button generator to make the process
            quick and easy.
          </p>
        </div>
      </section>
